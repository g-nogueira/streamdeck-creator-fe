			...
			<div
				...
				{#if customizableIcon.styles.labelVisible}
					<div
						...
						style="color: {customizableIcon.styles.labelColor}; font-family: {fontFamily}; transform: translate({customizableIcon.styles.labelX}px, {customizableIcon.styles.labelY}px);"
